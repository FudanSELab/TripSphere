...
1. Starlette auto-instrumentation (HTTP server, for A2A apps)
...
def setup_telemetry(
    ...
    2. Starlette auto-instrumentation (for A2A apps)
...
def instrument_starlette(app) -> None:
    ...
    This should be called after creating the Starlette app instance.
    It automatically:
    ...
    try:
        ...
        logger.info("✓ Starlette auto-instrumentation enabled")
    except Exception as e:
        logger.error(f"Failed to instrument Starlette: {e}")
