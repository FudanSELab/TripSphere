 ...
 * for deduplicating and properly merging Tailwind CSS classes
 */
...
/**
 * Generate a random avatar color based on user ID or name
 */
...
/**
 * Generate UUID v7-like ID (for client-side use only)
 */
