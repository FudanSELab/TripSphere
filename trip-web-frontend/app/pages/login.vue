    ...
    <div class="w-full max-w-md">
      ...
      <UiCard class="animate-fade-in-up">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-500 mt-2">Sign in to continue to TripSphere</p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            type="button"
            class="flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors"
          >
