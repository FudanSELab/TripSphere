 ...
 * Extracts and validates JWT token from metadata and stores username in context
 * 
 * NOTE: This interceptor is now deprecated in favor of Spring Security's 
 * GrpcServerSecurityAutoConfiguration which uses JwtGrpcAuthenticationReader.
 * This class is kept for backward compatibility but can be removed if not needed.
 */
// @Component
