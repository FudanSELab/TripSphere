...
public class HotelService {
    ...
    public List<Hotel> findHotelsWithinCircle(
            double lng, double lat, double radiusKm, String name, List<String> tags) {
        double radiusInRadians = radiusKm / 6378.1; // convert km -> radians for $centerSphere
        String nameRegex = (name == null || name.isBlank()) ? ".*" : ".*" + name + ".*";
        return hotelRepository.findByLocationWithinWithFilters(
     ...
     */
    public Page<Hotel> findHotelsWithinRadius(
            double lng,
            double lat,
            double radiusKm,
            String name,
     ...
     * @return The page of hotels
     */
    public Page<Hotel> findHotelsWithinCircle(
            double lng,
            double lat,
            double radiusKm,
            String name,
