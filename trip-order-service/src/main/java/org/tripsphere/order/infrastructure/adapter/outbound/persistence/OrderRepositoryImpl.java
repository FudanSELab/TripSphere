...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    @Override
    public Optional<Order> findByUserIdAndRequestId(String userId, String requestId) {
        return orderJpaRepository.findByUserIdAndRequestId(userId, requestId).map(entity -> {
            List<OrderItemEntity> items = orderItemJpaRepository.findByOrderId(entity.getId());
            return mapper.toDomain(entity, items);
        });
    }
