...
from litellm.utils import decode, encode  # pyright: ignore[reportUnknownVariableType]
...
class LitellmTokenizer(Tokenizer):
    ...
    def encode(self, text: str) -> list[int]:
        ...
        """
        return cast(list[int], encode(model=self.model_name, text=text))
    ...
    def decode(self, tokens: list[int]) -> str:
        ...
        """
        return cast(str, decode(model=self.model_name, tokens=tokens))
