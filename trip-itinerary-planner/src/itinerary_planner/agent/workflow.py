...
def create_planning_workflow() -> CompiledStateGraph[
    ...
    workflow.add_node("research_and_plan", research_and_plan_node)  # pyright: ignore
    workflow.add_node("finalize_itinerary", finalize_itinerary_node)  # pyright: ignore
